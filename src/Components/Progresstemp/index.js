...
function CircularProgressWithLabeltemp(props) {
  return (
...
CircularProgressWithLabeltemp.propTypes = {
  value: PropTypes.number.isRequired,
};

export default function CircularWithValueLabeltemp() {
  ...
  return (
    <div style={{ marginTop:'7vh' , marginLeft:'8vh' , height: '100vh' }}>
      <CircularProgressWithLabeltemp value={progress} />
    </div>
  );
}